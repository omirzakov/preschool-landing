...
const FAQS = [
  ...
  {
    q: 'Поддерживается ли оплата через банк?',
    a: 'Да. На тарифах «Стандарт» и «Премиум» доступна интеграция с банком БЦК: родители оплачивают квитанции прямо в приложении, а поступления автоматически отражаются у бухгалтера.',
  },
  {
